...
public class MainController {
    ...
    private void showRecommendationAdmin() {
        try {
            System.out.println("Loading Recommendation Admin panel...");

            // Get the FXML loader
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/fxml/admin_recommendation.fxml"));
            ...
            if (controller == null) {
                throw new IOException("Failed to get RecommendationAdminController");
            }
            ...
            e.printStackTrace();
            AlertUtils.showError("Error", "Failed to load Recommendation Admin panel: " + e.getMessage());
        } catch (Exception e) {
    ...
    private void handleCommentSubmit(Recommendation recommendation, String comment) {
        if (comment != null && !comment.trim().isEmpty()) {
            // TODO: Implement comment submission to database
            AlertUtils.showInfo("Success", "Comment submitted successfully!");
        }
    }
